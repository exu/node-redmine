...
Redmine.prototype.updateTimeEntry = function(id, params, callback) {
  this.request('PUT', '/time_entries/' + id + '.json', {time_entry: params}, callback);
};

Redmine.prototype.deleteTimeEntry = function(id, callback) {
